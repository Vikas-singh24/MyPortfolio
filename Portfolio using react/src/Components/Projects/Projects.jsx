    ...
    <div id='projects'>
      ...
      <div className="projectBox">
        {ProjectLists.map((item)=>(
         ...
         <a href={item.live} target='_blank'>  <button  className='projectView' style={{display: item.id<3? 'block' : 'none'}} >Live <FaArrowRightLong/> </button></a> 
        </div>
        </AnimateOnScroll>
        ))}
